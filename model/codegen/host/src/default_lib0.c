// tvm target: c -keys=cpu -link-params=0 -march=armv7e-m -mcpu=cortex-m7 -model=stm32f746xx -system-lib=0
#define TVM_EXPORTS
...
extern "C" {
#endif
static const float __attribute__((section(".rodata.tvm"), aligned(16))) __tvm_param__p1[16] = {
...
extern "C" {
#endif
static const float __attribute__((section(".rodata.tvm"), aligned(16))) __tvm_param__p0[16] = {
...
extern "C" {
#endif
static const float __attribute__((section(".rodata.tvm"), aligned(16))) __tvm_param__p4[16] = {
...
extern "C" {
#endif
static const float __attribute__((section(".rodata.tvm"), aligned(16))) __tvm_param__p2[256] = {
...
extern "C" {
#endif
static const float __attribute__((section(".rodata.tvm"), aligned(16))) __tvm_param__p3[16] = {
...
extern "C" {
#endif
static const float __attribute__((section(".rodata.tvm"), aligned(16))) __tvm_param__p5[1] = {
    -0x1.928ffp-2
};
#ifdef __cplusplus
}  // extern "C"
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_dense_add(float* placeholder, float* placeholder1, float* placeholder2, float* T_add) {
  float packed_weight[16];
  float compute_global[1];
  for (int32_t y = 0; y < 16; ++y) {
    packed_weight[(y)] = placeholder1[(y)];
  }
  ...
  T_add[(0)] = (compute_global[(0)] + placeholder2[(0)]);
  return 0;
}
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_dense_add_nn_relu_1(float* placeholder, float* placeholder1, float* placeholder2, float* T_relu) {
  ...
  for (int32_t z = 0; z < 2; ++z) {
    for (int32_t y = 0; y < 16; ++y) {
      for (int32_t x = 0; x < 8; ++x) {
        ((float*)packed_weight)[((((z * 128) + (y * 8)) + x))] = placeholder1[((((z * 128) + (x * 16)) + y))];
      }
    }
  }
  for (int32_t ax1_outer_ax0_outer_fused = 0; ax1_outer_ax0_outer_fused < 2; ++ax1_outer_ax0_outer_fused) {
    ...
    for (int32_t ax1_inner_inner = 0; ax1_inner_inner < 8; ++ax1_inner_inner) {
      float _1 = compute_global[(ax1_inner_inner)] + placeholder2[(((ax1_outer_ax0_outer_fused * 8) + ax1_inner_inner))];
      T_relu[(((ax1_outer_ax0_outer_fused * 8) + ax1_inner_inner))] = ((_1) > (0.000000e+00f) ? (_1) : (0.000000e+00f));
    }
  }
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_fused_nn_dense_add_nn_relu(float* placeholder, float* placeholder1, float* placeholder2, float* T_relu) {
  float packed_weight[16];
  for (int32_t z = 0; z < 2; ++z) {
    for (int32_t x = 0; x < 8; ++x) {
      packed_weight[(((z * 8) + x))] = placeholder1[(((z * 8) + x))];
    }
  }
  for (int32_t ax1_outer_ax0_outer_fused = 0; ax1_outer_ax0_outer_fused < 2; ++ax1_outer_ax0_outer_fused) {
    float compute_global[8];
...
extern "C"
#endif
TVM_DLL int32_t tvmgen_default_run_model(void* input, void* output) {
  ...
  (void)tvmgen_default_fused_reshape(input, sid_6);
  (void)tvmgen_default_fused_nn_dense_add_nn_relu(sid_6, __tvm_param__p0, __tvm_param__p1, sid_5);
  (void)tvmgen_default_fused_reshape_1(sid_5, sid_6);
  (void)tvmgen_default_fused_nn_dense_add_nn_relu_1(sid_6, __tvm_param__p2, __tvm_param__p3, sid_5);
  (void)tvmgen_default_fused_reshape_1(sid_5, sid_6);
  (void)tvmgen_default_fused_nn_dense_add(sid_6, __tvm_param__p4, __tvm_param__p5, output);
